...
from autopypath.types._no_path import _NoPath, _UsagePreventedType, NotSupported, _NOT_SUPPORTED_ERR
...
def test_exists_raises(no_path: _NoPath) -> None:
    with pytest.raises(NotSupported, match=_NOT_SUPPORTED_ERR):

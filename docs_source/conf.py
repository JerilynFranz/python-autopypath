...
from autopypath import _meta

# -- Project information -----------------------------------------------------

project: str = _meta.__project__
copyright: str = _meta.__copyright__  # noqa: A001
...
latex_documents = [(master_doc, 'simplebench.tex', 'simplebench Documentation', 'Jerilyn Franz', 'manual')]
...
man_pages = [(master_doc, 'simplebench', 'simplebench Documentation', [author], 1)]
